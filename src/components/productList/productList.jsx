...
const products = [
    ...
    {id: '35', title: 'Pass Clash Royale Gold', price: 545, description: "Товар на скидке", img: "/images/pass-royale-gold.png", category: 'royale'},
    {id: '36', title: 'Pass Clash Royale Diamond', price: 1020, description: "Товар на скидке", img: "/images/pass-royale-diamond.png", category: 'royale'},
    {id: '37', title: '80 Clash Royale Gems', price: 100, description: "Товар на скидке", img: "/images/royale-gems.png", category: 'royale'},
    {id: '38', title: '500 Clash Royale Gems', price: 430, description: "Товар на скидке", img: "/images/royale-gems.png", category: 'royale'},
    {id: '39', title: '1200 Clash Royale Gems', price: 835, description: "Товар на скидке", img: "/images/royale-gems.png", category: 'royale'},
    {id: '40', title: '2500 Clash Royale Gems', price: 1600, description: "Товар на скидке", img: "/images/royale-gems.png", category: 'royale'},
    {id: '41', title: '6500 Clash Royale Gems', price: 3800, description: "Товар на скидке", img: "/images/royale-gems.png", category: 'royale'},
    {id: '42', title: '14000 Clash Royale Gems', price: 7540, description: "Товар на скидке", img: "/images/royale-gems.png", category: 'royale'},

    {id: '43', title: 'Clash of Clans Gold', price: 600, description: "Со скидкой - 300", img: "/images/clash-pass.png", category: 'clash'},
    {id: '44', title: '80 Clash of Clans Gems', price: 100, description: "Товар на скидке", img: "/images/clash-gems.png", category: 'clash'},
    {id: '45', title: '500 Clash of Clans Gems', price: 430, description: "Товар на скидке", img: "/images/clash-gems.png", category: 'clash'},
    {id: '46', title: '1200 Clash of Clans Gems', price: 835, description: "Товар на скидке", img: "/images/clash-gems.png", category: 'clash'},
    {id: '47', title: '2500 Clash of Clans Gems', price: 1600, description: "Товар на скидке", img: "/images/clash-gems.png", category: 'clash'},
    {id: '48', title: '6500 Clash of Clans Gems', price: 3800, description: "Товар на скидке", img: "/images/clash-gems.png", category: 'clash'},
    {id: '49', title: '14000 Clash of Clans Gems', price: 7540, description: "Товар на скидке", img: "/images/clash-gems.png", category: 'clash'},

    {id: '50', title: 'Снабжение експресса', price: 435, description: "Товар на скидке", img: "/images/express.webp", category: 'honkai'},
    {id: '51', title: '60 Нефритов', price: 120, description: "Товар на скидке", img: "/images/nefrit.png", category: 'honkai'},
    {id: '52', title: '300 Нефритов', price: 570, description: "Товар на скидке", img: "/images/nefrit.png", category: 'honkai'},
    {id: '53', title: '980 Нефритов', price: 1550, description: "Товар на скидке", img: "/images/nefrit.png", category: 'honkai'},
    {id: '54', title: '1980 Нефритов', price: 3000, description: "Товар на скидке", img: "/images/nefrit.png", category: 'honkai'},
    {id: '55', title: '3280 Нефритов', price: 5000, description: "Товар на скидке", img: "/images/nefrit.png", category: 'honkai'},
    {id: '56', title: '6480 Нефритов', price: 9750, description: "Товар на скидке", img: "/images/nefrit.png", category: 'honkai'},
    {id: '57', title: 'Слава Безымянных', price: 1020, description: "Товар на скидке", img: "/images/slava-nameless.png", category: 'honkai'},
...
const ProductList = () => {
    ...
    useEffect(() => {
      if (showForm) {
        ...
        if (newWindow) {
          newWindow.document.title = 'Form'; // Optional: Set title of the new window
          newWindow.document.body.innerHTML = '<div id="form-container"></div>';
          ReactDOM.render(<Form />, newWindow.document.getElementById('form-container'));
        } else {
    ...
    return (
      <div>
        {isCartVisible ? (
          <Cart items={addedItems} onRemove={handleRemove} onPay={handlePay} onClose={handleCloseCart} />
        ) : (
          <div className="container">
            <div className="filter">
              <label htmlFor="category">Продукт: </label>
